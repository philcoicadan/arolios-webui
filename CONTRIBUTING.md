...
By participating, you are expected to uphold this code. Please report unacceptable behavior by mailing to [this address](mailto:philcoicadan@arolios.org).


## I Have a Question

> If you want to ask a question, we assume that you have read the available [Documentation](https://lab.frogg.it/philcoicadan/arolios-doc).
...
- Determine if your bug is really a bug and not an error on your side e.g. using incompatible environment components/versions (Make sure that you have read the [documentation](https://lab.frogg.it/philcoicadan/arolios-doc). If you are looking for support, you might want to check [this section](#i-have-a-question)).
...
> You must never report security related issues, vulnerabilities or bugs including sensitive information to the issue tracker, or elsewhere in public. Instead sensitive bugs must be sent by mailing to [this address](mailto:philcoicadan@arolios.org).
...
- Make sure that you are using the latest version.
- Read the [documentation](https://lab.frogg.it/philcoicadan/arolios-doc) carefully and find out if the functionality is already covered, maybe by an individual configuration.
